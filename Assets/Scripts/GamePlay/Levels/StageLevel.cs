...
public class StageLevel : MonoBehaviour, ILevel
{
    ...
    void Awake()
    {
        ...
        path1 = new Path("Path1", FillPointsList(path1_points, _tp_Array), 100);
        path2 = new Path("Path2", FillPointsList(path2_points, _tp_Array), 1);
        _pathlist.Add(path1);
        _pathlist.Add(path2);

        air_path1 = new Path("AirPath1", FillPointsList(air_path1_points, _tp_Array_air), 1);

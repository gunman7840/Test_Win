...
public class AirNavigation : MonoBehaviour
{

    protected Level2_air LevelData;
    ...
    void Awake()
    {
        // Debug.Log("air navigation awake");
        // awake чтобы инициализировать траектории были готовы к моменту старта Player
        LevelData = GameObject.Find("path_air").GetComponent<Level2_air>(); //Получаем доступ к классу
    ...
    /*
    //Рейтинги пока убираем, может они ни к чему
